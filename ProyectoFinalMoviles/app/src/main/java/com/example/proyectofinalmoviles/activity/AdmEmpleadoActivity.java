...
public class AdmEmpleadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adm_empleado);
        ...
        rv = (RecyclerView)findViewById(R.id.rvEmpleado);
        ...
        btnUpd = findViewById(R.id.btnUpEmpleado);

        btnDel = findViewById(R.id.btnEliminar);
        btnFind = findViewById(R.id.btnBuscar);
        btnList= findViewById(R.id.btnListadoEmpleados);
